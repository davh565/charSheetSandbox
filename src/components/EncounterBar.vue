...
<div>
        ...
        hide-overlay
        :light="!dark"
        v-model="encounterBar"
        :permanent="encounterBar"
        ...
        <span slot="badge">{{20-index}}</span>
                ...
                <v-btn absolute right :color="themecolor">
                Turn Complete
...
export default {
    ...
    data () {
        return {
          ...
          { divider: true, inset: true },
          { avatar: '/static/icons/Karghothor.svg', title: 'Karghothor the Vile', subtitle: "<span class='text--primary'>Fiend</span> &mdash; Uninjured" },
          { divider: true, inset: true },
        ],
        }
    },
